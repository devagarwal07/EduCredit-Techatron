      ...
      >
        ...
        <div className="container mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            {/* Dashboard link */}
            <div key="dashboard-link">
              <Link
                href="/dashboard"
                className="text-sm font-medium relative transition-colors duration-300 text-gray-300 hover:text-white"
              >
                Dashboard
                {pathname === "/dashboard" && (
                  <motion.span
                  ...
                  >
                    {item.children ? (
                      <div className="space-y-3">
                        <button
                          className={`flex items-center text-lg font-medium transition-colors duration-300 ${activeDropdown === item.name
                            ? "text-indigo-400"
                            : "text-gray-300 hover:text-white"
                            }`}
                          onClick={() => toggleDropdown(item.name)}
                        >
                          {item.name}
                          <ChevronDown
                            className={`h-4 w-4 ml-1 transition-transform duration-200 ${activeDropdown === item.name ? "rotate-180" : ""
                              }`}
                          />
                        </button>
                      ...
                      <Link
                        href={item.href}
                        className={`text-lg font-medium block py-2 transition-colors duration-300 ${pathname === item.href
                          ? "text-indigo-400"
                          : "text-gray-300 hover:text-white"
                          }`}
                        onClick={() => setIsOpen(false)}
