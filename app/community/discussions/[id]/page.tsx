...
export default function DiscussionPage({
    ...
    const [commentReactions, setCommentReactions] = useState<Record<string, { likes: number, dislikes: number }>>(
                            ...
                            >
                                ...
                                <div className="flex items-center gap-4 text-sm text-gray-300 border-t border-white/10 pt-4">
                                    <button
                                        ...
                                        className={`flex items-center gap-1 ${userReactions[comment.id] === 'like' ? "text-indigo-400" : ""}`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`flex items-center gap-1 ${userReactions[comment.id] === 'dislike' ? "text-red-400" : ""}`}
                                    >
